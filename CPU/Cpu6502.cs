...
namespace CPU
{
    public class Cpu6502
    {
        ...
        {
            byte instruction = _memoryManager[PC++];
        ...
        void LDA(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.LDA_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.LDA_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
        ...
        void STA(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.STA_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.STA_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException($"Instruction not implemented: {instruction:X2} ({instruction})")
            };
        ...
        /// </summary>
        void PHA() => _memoryManager[0x0100 | SP--] = A.Value;
        /// <summary>
        /// Push Processor Status on Stack
        /// </summary>
        void PHP() => _memoryManager[0x0100 | SP--] = PS;
        /// <summary>
        /// Pull Accumulator from Stack
        /// </summary>
        void PLA() => A.Value = _memoryManager[0x0100 | SP++];
        /// <summary>
        /// Pull Processor Status from Stack
        /// </summary>
        void PLP() => PS = _memoryManager[0x0100 | SP++];
        #endregion
        ...
        void AND(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.AND_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.AND_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException()
            };
            var b = _memoryManager[addr];
        ...
        void EOR(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.EOR_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.EOR_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException()
            };
            var b = _memoryManager[addr];
            A.Value = (byte)(A.Value ^ b);
        ...
        void ORA(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.ORA_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.ORA_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException()
            };
            var b = _memoryManager[addr];
            A.Value = (byte)(A.Value | b);
        ...
        void ADC(byte instruction)
        {
            ...
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.ADC_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.ADC_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException()
            };
            var b = _memoryManager[addr];
        ...
        void SBC(byte instruction)
        {
            ...
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.SBC_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.SBC_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException()
            };
            var b = _memoryManager[addr];
        ...
        void CMP(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.CMP_INDIRECT_X => _memoryManager[ReadZeroPageAddrFromMemory(offset: X.Value) & 0xFF],
                Cpu6502ByteCodesInstructions.CMP_INDIRECT_Y => _memoryManager[ReadZeroPageAddrFromMemory() + Y.Value],
                _ => throw new NotImplementedException()
            };
            var b = _memoryManager[addr];
            var res = A.Value - b;
        ...
        void JMP(byte instruction)
        {
            ushort addr = instruction switch
            {
                ...
                Cpu6502ByteCodesInstructions.JMP_INDIRECT => _memoryManager[ReadAddrFromMemory()],
                _ => throw new NotImplementedException()
            };
            PC = addr;
        }
        ...
        void JSR()
        {
            ...
            _memoryManager[0x100 | SP--] = (byte)(currentAddr & 0xFF);
        ...
        void RTS()
        {
            byte upper = _memoryManager[SP++];
            byte lower = _memoryManager[SP++];
        ...
        ushort ReadZeroPageAddrFromMemory(byte offset = 0) => ComputeAddrFromUL(_memoryManager[PC++], 0, offset);
        ushort ReadAddrFromMemory(byte offset = 0) => ComputeAddrFromUL(_memoryManager[PC++], _memoryManager[PC++], offset);

        static ushort ComputeAddrFromUL(byte lower, byte upper, byte offset = 0) => (ushort)(((upper << 8) | lower) + offset);
        ushort GetNmiAddress() => ComputeAddrFromUL(_memoryManager[Cpu6502Consts.NMI_ADDRESS_L], _memoryManager[Cpu6502Consts.NMI_ADDRESS_U]);
        ushort GetResetAddress() => ComputeAddrFromUL(_memoryManager[Cpu6502Consts.RESET_ADDRESS_L], _memoryManager[Cpu6502Consts.RESET_ADDRESS_U]);
        ushort GetBrkAddress() => ComputeAddrFromUL(_memoryManager[Cpu6502Consts.BRK_ADDRESS_L], _memoryManager[Cpu6502Consts.BRK_ADDRESS_U]);
    }
    ...
    public class Register
    {
        ...
        {
            Value = CPU._memoryManager[address];
            CPU.PS = CPU.PS with { Z = Value == 0, N = (Value >> 7 & 1) == 1 };
        }
        public void WriteValueToAddress(ushort address) => CPU._memoryManager[address] = Value;
